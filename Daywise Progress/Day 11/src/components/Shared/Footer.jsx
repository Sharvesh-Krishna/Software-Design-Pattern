import { Facebook, Github, Linkedin, Mail, Slack, Twitter } from 'lucide-react'
...
const Footer = () => {
  return (
    <div className=" w-full h-[8vh] flex flex-row justify-center items-center border-t-2 border-primary/50">
      <div className="w-1/4 h-full text-primary font-bold flex justify-start items-center text-lg"> © ShiftSymphony 2024</div>
